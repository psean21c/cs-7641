...
range_values = range(100,815,100)

for value in range_values:
	fitness = mlrose_hiive.MaxKColor(edges[:value])
	max_node = 0
	for i in range(value):
		x,y = edges[i]
		max_node = max(x,max_node)
		max_node = max(y,max_node)
	problem = mlrose_hiive.DiscreteOpt(length = max_node+1, fitness_fn = fitness, maximize = False, max_val = 2)
	problem.set_mimic_fast_mode(True)
	# init_state = np.random.randint(2, size = max_node+1)
	start = time.time()
	_, best_fitness_sa, _ = mlrose_hiive.simulated_annealing(problem, schedule = mlrose_hiive.ExpDecay(), max_attempts = 100, max_iters = 200, curve = True)
	end = time.time()
	sa_time = end - start
	...
	start = time.time()
	_, best_fitness_ga, _ = mlrose_hiive.genetic_alg(problem, pop_size = 100, max_attempts = 10, curve = True)
	end = time.time()
	ga_time = end - start
	...
	start = time.time()
	_, best_fitness_mimic, _ = mlrose_hiive.mimic(problem, pop_size = 100, max_attempts = 15, curve = True)
	end = time.time()
...
plt.title('Fitness vs. Problem Size (Max K Colors)')
plt.xlabel('Problem Size')
plt.ylabel('Fitness')
plt.legend()
plt.savefig('k_color_fitness.png')
...
plt.title('Time Efficiency vs. Problem Size (Max K Colors)')
plt.legend()
plt.xlabel('Problem Size')
plt.ylabel('Computation Time (s)')
plt.savefig('k_color_computation.png')
...
problem.set_mimic_fast_mode(True)
init_state = np.random.randint(2, size = max_node+1)
_, best_fitness_sa, fitness_curve_sa = mlrose_hiive.simulated_annealing(problem, schedule = mlrose_hiive.ExpDecay(), max_attempts = 100, max_iters = 200, curve = True)
print("Done with SA iterations!")
print(best_fitness_sa)
_, best_fitness_rhc, fitness_curve_rhc = mlrose_hiive.random_hill_climb(problem, curve = True)
print("Done with RHC iterations!")
print(best_fitness_rhc)
_, best_fitness_ga, fitness_curve_ga = mlrose_hiive.genetic_alg(problem, pop_size = 100, max_attempts = 10, curve = True)
print("Done with GA iterations!")
print(best_fitness_ga)
_, best_fitness_mimic, fitness_curve_mimic = mlrose_hiive.mimic(problem, pop_size = 100, max_attempts = 15, curve = True)
...
plt.title('Fitness Curve (Max K Color)')
plt.legend()
plt.xlabel('Percentage of Iterations')
plt.ylabel('Fitness Evaluations')
plt.savefig('k_color_fitness_eval.png')
...
# _, _, fitness_curve_sa_1 = mlrose_hiive.simulated_annealing(problem, schedule = mlrose_hiive.ExpDecay(), max_attempts = 100, max_iters = 3000, init_state = init_state, curve = True)
# _, _, fitness_curve_sa_2 = mlrose_hiive.simulated_annealing(problem, schedule = mlrose_hiive.GeomDecay(), max_attempts = 100, max_iters = 3000, init_state = init_state, curve = True)
# _, _, fitness_curve_sa_3 = mlrose_hiive.simulated_annealing(problem, schedule = mlrose_hiive.ArithDecay(), max_attempts = 100, max_iters = 3000, init_state = init_state, curve = True)
...
# _, _, fitness_curve_rhc_1 = mlrose_hiive.random_hill_climb(problem, restarts = 0, max_attempts = 100, max_iters = 3000, init_state = init_state, curve = True)
# _, _, fitness_curve_rhc_2 = mlrose_hiive.random_hill_climb(problem, restarts = 4, max_attempts = 100, max_iters = 3000, init_state = init_state, curve = True)
# _, _, fitness_curve_rhc_3 = mlrose_hiive.random_hill_climb(problem, restarts = 8, max_attempts = 100, max_iters = 3000, init_state = init_state, curve = True)
# _, _, fitness_curve_rhc_4 = mlrose_hiive.random_hill_climb(problem, restarts = 12, max_attempts = 100, max_iters = 3000, init_state = init_state, curve = True)
# _, _, fitness_curve_rhc_5 = mlrose_hiive.random_hill_climb(problem, restarts = 16, max_attempts = 100, max_iters = 3000, init_state = init_state, curve = True)
...
# _, _, fitness_curve_mimic_1 = mlrose_hiive.mimic(problem, keep_pct = 0.1, pop_size = 100, max_attempts = 100, max_iters = 50, curve = True)
# _, _, fitness_curve_mimic_2 = mlrose_hiive.mimic(problem, keep_pct = 0.3, pop_size = 100, max_attempts = 100, max_iters = 50, curve = True)
# _, _, fitness_curve_mimic_3 = mlrose_hiive.mimic(problem, keep_pct = 0.1, pop_size = 200, max_attempts = 100, max_iters = 50, curve = True)
# _, _, fitness_curve_mimic_4 = mlrose_hiive.mimic(problem, keep_pct = 0.3, pop_size = 200, max_attempts = 100, max_iters = 50, curve = True)
# _, _, fitness_curve_mimic_5 = mlrose_hiive.mimic(problem, keep_pct = 0.1, pop_size = 500, max_attempts = 100, max_iters = 50, curve = True)
# _, _, fitness_curve_mimic_6 = mlrose_hiive.mimic(problem, keep_pct = 0.3, pop_size = 500, max_attempts = 100, max_iters = 50, curve = True)
