...
range_values = [5, 15, 25, 35, 45, 85]

for value in range_values:
	fitness = mlrose_hiive.SixPeaks(t_pct = 0.1)
	...
	start = time.time()
	_, best_fitness_sa, _ = mlrose_hiive.simulated_annealing(problem, schedule = mlrose_hiive.ExpDecay(), max_attempts = 10, max_iters = 2000, curve = True)
	end = time.time()
	sa_time = end - start
	print("SA:", sa_time, value)

	start = time.time()
	_, best_fitness_rhc, _ = mlrose_hiive.random_hill_climb(problem, max_attempts = 10, max_iters = 2000, curve = True)
	end = time.time()
	rhc_time = end - start
	...
	start = time.time()
	_, best_fitness_mimic, _ = mlrose_hiive.mimic(problem, pop_size = 500, max_attempts = 20, curve = True)
	end = time.time()
...
plt.title('Fitness vs. Problem Size (Six Peaks)')
plt.xlabel('Problem Size')
plt.ylabel('Fitness')
plt.legend()
plt.savefig('six_peaks_fitness.png')
...
plt.title('Time Efficiency vs. Problem Size (Six Peaks)')
plt.legend()
plt.xlabel('Problem Size')
plt.ylabel('Computation Time (s)')
plt.savefig('six_peaks_computation.png')
...
_, _, fitness_curve_sa = mlrose_hiive.simulated_annealing(problem, schedule = mlrose_hiive.ExpDecay(), max_attempts = 10, max_iters = 2000, curve = True)
print("Done with SA iterations!")
_, _, fitness_curve_rhc = mlrose_hiive.random_hill_climb(problem, max_attempts = 10, max_iters = 2000, curve = True)
...
_, _, fitness_curve_mimic = mlrose_hiive.mimic(problem, pop_size = 500, max_attempts = 20, curve = True)
...
plt.title('Fitness Curve (Six Peaks)')
plt.legend()
plt.xlabel('Percentage of Iterations')
plt.ylabel('Fitness Evaluations')
plt.savefig('six_peaks_fitness_eval.png')
...
plt.ylabel('Fitness')
plt.savefig('six_peaks_iterations.png')
...
# fitness = mlrose_hiive.SixPeaks(t_pct = 0.3)
# problem = mlrose_hiive.DiscreteOpt(length = problem_length, fitness_fn = fitness, maximize = True, max_val = 2)
# problem.set_mimic_fast_mode(True)
# init_state = np.random.randint(2, size = problem_length)
...
# plt.title('Fitness Curve for Varying Thresholds (Six Peaks)')
# plt.legend()
# plt.xlabel('Iterations')
# plt.ylabel('Fitness')
# plt.subplot(312)
...
# plt.xlabel('Iterations')
# plt.ylabel('Fitness')
# plt.savefig('six_peaks_threshold.png')
...
# plt.title('Simulated Annealing Analysis (Six Peaks)')
# plt.legend()
# plt.xlabel('Iterations')
# plt.ylabel('Fitness')
# plt.savefig('six_peaks_sa.png')
...
# plt.title('Randomized Hill Climb Analysis (Six Peaks)')
# plt.legend()
# plt.xlabel('Iterations')
# plt.ylabel('Fitness')
# plt.savefig('six_peaks_rhc.png')
...
# plt.title('MIMIC Analysis (Six Peaks)')
# plt.legend()
# plt.xlabel('Iterations')
# plt.ylabel('Fitness')
# plt.savefig('six_peaks_mimic.png')
...
# plt.title('GA Analysis (Six Peaks)')
# plt.legend()
# plt.xlabel('Iterations')
# plt.ylabel('Fitness')
# plt.savefig('six_peaks_ga.png')